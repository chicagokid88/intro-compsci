...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        lowerCaseShift = lowerCase[shift:] + lowerCase[:shift]
        upperCaseShift = upperCase[shift:] + upperCase[:shift]
        
        keys = lowerCase+upperCase
        values = lowerCaseShift+upperCaseShift
        
        for i in range(0,len(lowerCase+upperCase)):
            shiftDict[keys[i]] = values[i]
